...
import { HiveProvider } from "@/lib/hive-client";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "HiveXPH SDK Playground" },
      {
        name: "description",
        content:
          "Developer playground for the HiveXPH SDK: Keychain transactions, block streaming and transaction reading.",
      },
